...
/*   Updated: 2022/03/26 13:11:42 by zerudo           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_array	*find_next(t_array **start, int index)//find the next nbr after the given index. if the index is greater, it will returns 0
{
	t_array	*top;
	t_array	*temp = NULL;
...
t_array	*find_next_no_lis(t_stack *a, int	*suite)//find the next nbr after the given index. if the index is greater, it will returns 0
{
	t_array	*top;
	t_array	*temp = NULL;
